...
# ------------------------------------------------------------
# deploy.sh (gaminghub host)
#
# Runs on: gaminghub host (runner-per-host, shell executor)
# Purpose:
...
SOPS_ENV_REL="hosts/gaminghub/secrets/compose.env.sops"
SOPS_ENV_FILE="${REPO_DIR}/${SOPS_ENV_REL}"

# Live stack directory on the gaminghub host
LIVE_STACK_DIR="${LIVE_STACK_DIR:-/home/gaminghub/gaminghub-hub/compose}"
