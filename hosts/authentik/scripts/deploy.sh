...
# ------------------------------------------------------------
# deploy.sh (authentik host)
#
# Runs on: authentik host (runner-per-host, shell executor)
# Purpose:
...
SOPS_ENV_REL="hosts/authentik/secrets/compose.env.sops"
SOPS_ENV_FILE="${REPO_DIR}/${SOPS_ENV_REL}"

# Live stack directory on the authentik host
LIVE_STACK_DIR="${LIVE_STACK_DIR:-/home/authentik/authentik-hub/compose}"
